-- ============================================================
-- Crypto Paper Trading Bot — Full PostgreSQL Schema
-- ============================================================
-- This schema supports daily paper trading sessions, individual
-- trade records, LLM reflection reports, regime performance
-- aggregations, and parameter change history.
-- ============================================================
...
-- -----------------------------------------------------------
-- Trades: every individual trade within a session
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- Reflections: LLM analysis output per session
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- Regime Performance: aggregated stats per market regime
-- -----------------------------------------------------------
...
-- -----------------------------------------------------------
-- Parameter History: tracks AI-suggested parameter changes
-- -----------------------------------------------------------
